...
def __from_env():
    ...
    if env_sparse_attn_backend is not None and env_sparse_attn_backend in ['sage', 'xformers', 'flash_attn', 'flash_attn_3']:
...
def set_attn_backend(backend: Literal['sage', 'xformers', 'flash_attn', 'flash_attn_3']):
    global ATTN
    ATTN = backend
