...
class FlowEulerSampler(Sampler):
    ...
    def sample_once(
        ...
        **kwargs
        ...
        pred_x_0 = self._pred_to_xstart(x_t, t, pred_v) if return_x_0 else None
    ...
    def sample(
        ...
        **kwargs
        ...
        Args:
            ...
            store_intermediates: If True, keep per-step predictions in the
                returned object. Disable during inference to reduce peak memory.
        ...
        for t, t_prev in tqdm(t_pairs, desc=tqdm_desc, disable=not verbose):
            out = self.sample_once(
                ...
                t_prev,
                cond,
                return_x_0=store_intermediates,
                **kwargs,
            )
